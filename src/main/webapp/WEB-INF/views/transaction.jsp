...
<body>
	...
	<div class="main-warp">
		...
		<header class="header-section">
			...
			<div class="header-warp">
				...
				<ul class="main-menu">
					...
					<li class="active"><a href="transaction">Add Transaction</a></li>
				...
				<div class="row">
					<div class="col-xl-6 p-0">
						<div class="contact-text">
							...
							<sf:form method="POST" modelAttribute="money" commandName="money" class="contact-form">
		Reason of Deposit:
		<sf:input type='text' path="ftra_reason" placeholder="Reason of Deposit"/><br>
		Amount:
		...
		<sf:button type="submit" name='submit' class="site-btn">Submit</sf:button>
								</sf:form>
						</div>
					</div>
					<div class="col-xl-6 p-0">
