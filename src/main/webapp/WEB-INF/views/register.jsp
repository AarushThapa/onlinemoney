		...
		<header class="header-section">
			...
			<div class="header-warp">
				...
				<ul class="main-menu">
					...
					<li class="active"><a href="<c:url value='registeruser' />">Create a Account</a></li>
					</c:otherwise>
					</c:choose>
				</ul>
				...
				<div class="row">
					<div class="col-xl-6 p-0">
						<div class="contact-text">
							<span>Online Money Management System</span>
							<h2>Register Now</h2>
							<sf:form  class="contact-form" method="POST" modelAttribute="org" commandName="org">

								Organization Name:
								<sf:input type="text" path="org_name" placeholder="Organization Name"/><br>
								Organization Details:
								<sf:input type="text" path="org_details" placeholder="Organization Detail"/><br>
								Organization Password:
								<sf:input type="password" path="org_pw" placeholder="Password"/><br>
								Organization Address:
								<sf:input type="text" path="org_address" placeholder="Address"/><br>
								Organization Email:
								<sf:input type="email" path="org_email" placeholder="Email"/><br>
								Organization Contact:
								<sf:input type="number" path="org_contact" placeholder="123456789"/><br>
								<sf:button class="site-btn" type="submit">submit</sf:button>
